...
public class ReviewBookRepositoryImpl {
    ...
    public boolean reviewBook(long bookId, long userId, String review, double rating) {
        ...
        String insertQuery = "INSERT INTO review_books (book_id, user_id, review, rating) VALUES (?, ?, ?, ?)";
        String updateQuery = "UPDATE read_books SET is_reviewed = true WHERE book_id = ? AND user_id = ?";
